...
class SwitchUpdatePage(BasePage):

    def __init__(self, driver):
        super().__init__(driver)
        if self.platform == GlobalVar.IOS:
            from src.eufyhome.ios.switchs.SwitchUpdateActivity import SwitchUpdateActivity
        else:
            from src.eufyhome.android.switchs.SwitchUpdateActivity import SwitchUpdateActivity
        global Page
        Page = SwitchUpdateActivity()
