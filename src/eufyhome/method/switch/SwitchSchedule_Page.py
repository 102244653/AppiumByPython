...
class SwitchSchedulePage(BasePage):

    def __init__(self, driver):
        super().__init__(driver)
        if self.platform == GlobalVar.IOS:
            from src.eufyhome.ios.switchs.SwitchScheduleActivity import SwitchScheduleActivity
        else:
            from src.eufyhome.android.switchs.SwitchScheduleActivity import SwitchScheduleActivity
        global Page
        Page = SwitchScheduleActivity()
    ...
    def add_new_schedule(self, device=None, yt=0):
        ...
        self.tap_element(Page.switch_status)
    ...
    def edit_switch_away_mode(self, yt):
        """
        编辑离家模式
        :return:
        """
