...
class PlugUpdatePage(BasePage):

    def __init__(self, driver):
        super().__init__(driver)
        if self.platform == GlobalVar.IOS:
            from src.eufyhome.ios.plug.PlugUpdateActivity import PlugUpdateActivity
        else:
            from src.eufyhome.android.plug.PlugUpdateActivity import PlugUpdateActivity
        global Page
        Page = PlugUpdateActivity()
