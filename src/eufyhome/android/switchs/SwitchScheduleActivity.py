class SwitchScheduleActivity(object):
    # 返回
    back_switch = ('id', 'com.eufylife.smarthome:id/common_header_start_icon')
    ...
    # 开关状态
    switch_status = ('id', 'com.eufylife.smarthome:id/dialog_layout_on')
